    ...
    <div className='ProductionPage max-w-[1920px] w-full mx-auto mt-[15%] relative overflow-hidden md:mt-[100px] lg:mt-[120px] xl:mt-[100px]'>
      <div className="container">
        ...
        <div className="static-content flex gap-10 md:gap-0 flex-wrap max-w-[700px] w-full mx-auto justify-center md:justify-between items-center">
          ...
          >
            <h3 className="md:text-4xl text-2xl font-bold text-green-600">
              <AnimatedCounter value={5.5} decimalPlaces={1} /> <span className="block  font-semibold">{t('production.area')}</span>
            </h3>
            <p className="text-gray-600 text-sm md:text-lg leading-[1.2] w-[100px]">{t('production.production_area')}</p>
          </motion.div>
          {/* ~~~~~~~~~~~~~~~~~~~~2 */}
          <motion.div 
            className="flex items-center md:gap-2 gap-1"
          ...
          >
            ...
            <p className="text-gray-600 text-sm md:text-lg leading-[1.2] w-[100px]">{t('production.large_complexes')}</p>
          </motion.div>
          {/* ~~~~~~~~~~~~~~~~~~~~3 */}
          <motion.div 
            className="flex items-center md:gap-2 gap-1"
          ...
          >
            ...
            <p className="text-gray-600 text-sm md:text-lg leading-[1.2] w-[100px]">{t('production.product_types')}</p>
          </motion.div>
        </div>
